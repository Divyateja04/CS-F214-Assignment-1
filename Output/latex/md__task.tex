\hypertarget{md__task_autotoc_md3}{}\doxysection{Members}\label{md__task_autotoc_md3}
...
\begin{DoxyItemize}
\item CS F214\+: Logic in CS Assignment 1
\begin{DoxyItemize}
\item Members
...
\item Task 6\+: References Used
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md__task_autotoc_md5}{}\doxysection{Task 0\+: Initializing all the constants and libraries}\label{md__task_autotoc_md5}
\hypertarget{md__task_autotoc_md6}{}\doxysubsection{Importing libraries for the Code}\label{md__task_autotoc_md6}
...
\end{DoxyCode}
\hypertarget{md__task_autotoc_md7}{}\doxysubsection{Define a constant to take care of max limit of input}\label{md__task_autotoc_md7}

\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{preprocessor}{\#define max 100}}

\end{DoxyCode}
\hypertarget{md__task_autotoc_md8}{}\doxysubsection{Creating a structure with left and right leaves}\label{md__task_autotoc_md8}
...
\end{DoxyCode}
\hypertarget{md__task_autotoc_md9}{}\doxysubsection{Helper Function\+: max() A function to find the max of 2 numbers}\label{md__task_autotoc_md9}
...
\end{DoxyCode}
\hypertarget{md__task_autotoc_md10}{}\doxysection{Task 1\+: To convert infix to preorder}\label{md__task_autotoc_md10}
...
\end{DoxyItemize}\hypertarget{md__task_autotoc_md11}{}\doxysubsection{Create a stack to keep track of operators}\label{md__task_autotoc_md11}
...
\end{DoxyCode}
\hypertarget{md__task_autotoc_md12}{}\doxysubsection{Function to convert Infix to Prefix}\label{md__task_autotoc_md12}
...
\end{DoxyCode}
\hypertarget{md__task_autotoc_md13}{}\doxysection{Task 2\+: To convert prefix to tree}\label{md__task_autotoc_md13}
...
\end{DoxyCode}
\hypertarget{md__task_autotoc_md14}{}\doxysection{Task 3\+: Function to traverse through the tree in order}\label{md__task_autotoc_md14}
...
\end{DoxyCode}
 \hypertarget{md__task_autotoc_md15}{}\doxysection{Task 4\+: Height of the Parse Tree}\label{md__task_autotoc_md15}
...
\end{DoxyCode}
\hypertarget{md__task_autotoc_md16}{}\doxysection{Task 5\+: Evaluating the truth value of propositional logic formula in a bottoms up fashion}\label{md__task_autotoc_md16}
...
\DoxyCodeLine{        printf(\textcolor{stringliteral}{"{}\(\backslash\)n::>Performing \string~"{}});}
\DoxyCodeLine{        \textcolor{keywordflow}{return} !(rightVal);}
\DoxyCodeLine{    \textcolor{keywordflow}{case} \textcolor{charliteral}{'+'}:}
\DoxyCodeLine{        printf(\textcolor{stringliteral}{"{}\(\backslash\)n::>Performing +"{}});}
...
\end{DoxyCode}
\hypertarget{md__task_autotoc_md17}{}\doxysection{Task 6\+: $<$a href=\char`\"{}https\+://yuchen52.\+medium.\+com/profiling-\/with-\/gprof-\/64-\/bit-\/window-\/7-\/5e06ef614ba8\char`\"{} $>$\+References Used$<$/a$>$}\label{md__task_autotoc_md17}
