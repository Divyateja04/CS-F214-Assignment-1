\hypertarget{md__markdown__file_autotoc_md1}{}\doxysection{Members}\label{md__markdown__file_autotoc_md1}
...
\DoxyHorRuler{0}
\hypertarget{md__markdown__file_autotoc_md3}{}\doxysection{Task 0\+: Initializing all the constants and libraries}\label{md__markdown__file_autotoc_md3}
\hypertarget{md__markdown__file_autotoc_md4}{}\doxysubsection{Importing libraries for the Code}\label{md__markdown__file_autotoc_md4}
...
\end{DoxyCode}
\hypertarget{md__markdown__file_autotoc_md5}{}\doxysubsection{Define a constant to take care of max limit of input}\label{md__markdown__file_autotoc_md5}

\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{preprocessor}{\#define max 100}}

\end{DoxyCode}
\hypertarget{md__markdown__file_autotoc_md6}{}\doxysubsection{Creating a structure with left and right leaves}\label{md__markdown__file_autotoc_md6}
...
\end{DoxyCode}
\hypertarget{md__markdown__file_autotoc_md7}{}\doxysubsection{Helper Function\+: max() A function to find the max of 2 numbers}\label{md__markdown__file_autotoc_md7}
...
\end{DoxyCode}
\hypertarget{md__markdown__file_autotoc_md8}{}\doxysection{Task 1\+: To convert infix to preorder}\label{md__markdown__file_autotoc_md8}
...
\end{DoxyItemize}\hypertarget{md__markdown__file_autotoc_md9}{}\doxysubsection{Create a stack to keep track of operators}\label{md__markdown__file_autotoc_md9}
...
\end{DoxyCode}
\hypertarget{md__markdown__file_autotoc_md10}{}\doxysubsection{Function to convert Infix to Prefix}\label{md__markdown__file_autotoc_md10}
...
\end{DoxyCode}
\hypertarget{md__markdown__file_autotoc_md11}{}\doxysection{Task 2\+: To convert prefix to tree}\label{md__markdown__file_autotoc_md11}
...
\end{DoxyCode}
\hypertarget{md__markdown__file_autotoc_md12}{}\doxysection{Task 3\+: Function to traverse through the tree in order}\label{md__markdown__file_autotoc_md12}
...
\end{DoxyCode}
 \hypertarget{md__markdown__file_autotoc_md13}{}\doxysection{Task 4\+: Height of the Parse Tree}\label{md__markdown__file_autotoc_md13}
...
\end{DoxyCode}
\hypertarget{md__markdown__file_autotoc_md14}{}\doxysection{Task 5\+: Evaluating the truth value of propositional logic formula in a bottoms up fashion}\label{md__markdown__file_autotoc_md14}
...
\end{DoxyCode}
\hypertarget{md__markdown__file_autotoc_md15}{}\doxysection{Task 6\+:}\label{md__markdown__file_autotoc_md15}
